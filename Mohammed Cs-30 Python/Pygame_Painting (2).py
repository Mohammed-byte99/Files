...
while not done:
    ...
    for cloud in range (0, 400, 200): 
        pygame.draw.ellipse(screen, WHITE,  [185+cloud, 40, 90, 50], 0)
        pygame.draw.ellipse(screen, WHITE,  [245+cloud, 60, 50, 40], 0)
        pygame.draw.ellipse(screen, WHITE,  [185+cloud, 70, 90, 50], 0)
        pygame.draw.ellipse(screen, WHITE,  [165+cloud, 60, 50, 40], 0)
